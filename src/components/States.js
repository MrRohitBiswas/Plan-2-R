import s1 from "./components/WestBengal.webp";
import s2 from "./components/Kerala.webp";
import s3 from "./components/Rajasthan.webp";
import s4 from "./components/Goa.webp";
import s5 from "./components/Punjab.webp";
import s6 from "./components/HimachalPradesh.webp";
import s7 from "./components/UttarPradesh.webp";
import s8 from "./components/Gujarat.webp";
import s9 from "./components/JammuAndKashmir.webp";
import s10 from "./components/Karnataka.webp";
import s11 from "./components/TamilNadu.webp";
import s12 from "./components/Maharashtra.webp";
import s13 from "./components/Delhi.webp";
import s14 from "./components/Bihar.webp";
import s15 from "./components/Sikkim.webp";
import s16 from "./components/ArunachalPradesh.webp";
import s17 from "./components/Assam.webp";
import s18 from "./components/Meghalaya.webp";
import s19 from "./components/Manipur.webp";
import s20 from "./components/Tripura.webp";
import s21 from "./components/Nagaland.webp";
import s22 from "./components/Mizoram.webp";
import s23 from "./components/Uttarakhand.webp";
...
const States = [
  {
    ...
    content:
      "The beautiful state of West Bengal attracts a significant number of tourists every year as the state is jewelled with mesmerising landscapes, snow-clad mountains, gushing sea, blossoming tea gardens, enormous deltas, plentiful wildlife, and magnificent British monuments.",
    url: s1,
    slides: [
      {
        ...
        image:
          "https://youimg1.tripcdn.com/target/10020t000000igk5u4FDB.jpg?proc=source%2Ftrip"
      },
      {
        title: "Howrah Bridge",
        subtitle: "Howrah",
      ...
      },
      {
        ...
        image:
          "https://www.transindiatravels.com/wp-content/uploads/darjeeling-2-1.jpg"
      },
      {
        title: "Hazarduari",
        subtitle: "Murshidabad",
        description: "A piece of heaven",
        image:
          "https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Hazarduari_Palace%2C_Killa_Nizamat.jpg/2560px-Hazarduari_Palace%2C_Killa_Nizamat.jpg"
      },
      {
  ...
  },
  {
    ...
    stateName: "Kerala",
    content:
      "Kerala, a state situated on the tropical Malabar Coast of southwestern India, is one of the most popular tourist destinations in India. Named as one of the ten paradises of the world by National Geographic Traveler, Kerala is famous especially for its ecotourism initiatives and beautiful backwaters",
    url: s2,
    slides: [
      {
        title: "Vembanad Lake",
      ...
      },
      {
        ...
        description: "Twelfth district of God’s Own Country",
        image:
      ...
      },
      {
        ...
        image:
          "https://static.toiimg.com/photo/81695811.cms",
      },
      {
        title: "Munnar",
        subtitle: "Western Ghats",
  ...
  },
  {
    ...
    stateName: "Rajasthan",
    content:
      "Rajasthan is one of the most beautiful states in India when it comes to natural glamor.It is known for its colorful culture, exquisite palaces, and vibrant festivities.The state is home to the city of Jaipur, also known as the Pink City, which is renowned for its stunning architecture.",
    url: s3,
    slides: [
      {
        title: "Amber Fort",
        ...
        image:
          "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/17/d3/a8/57/images-30-largejpg.jpg?w=1200&h=-1&s=1",
      },
      {
        title: "Sonar Quila",
        subtitle: "Rajasthan",
        ...
        image:
          "https://www.swantour.com/blogs/wp-content/uploads/2019/02/Jaisalmer-Fort.jpg",
      },
      {
        title: "City Palace",
        subtitle: "Udaipur",
        ...
        image:
          "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/13/96/8a/82/this-is-the-time-when.jpg?w=1200&h=1200&s=1",
      },
      {
        title: "Four",
        subtitle: "Jodhpur",
        ...
        image:
          "https://www.tripsavvy.com/thmb/9UwtKJX6FWpYF3hxjhuXw2uHQsw=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/GettyImages-481776206-58fde26a5f9b581d59810c1d.jpg",
      },
      {
        title: "National Park",
        subtitle: "Ranthambore",
        description: "Structures that remind of bygone eras",
        image:
          "https://www.ranthamborenationalpark.com/wp-content/uploads/2020/05/package-features.jpg",
      },
    ],
  },
  {
    ...
    slides: [
      {
        title: "Palolem Beach",
        subtitle: "Palolem",
        description: "The white crescent beach",
        image:
          "https://www.planetware.com/wpimages/2020/06/india-goa-top-attractions-popular-beaches.jpg",
      },
      {
        title: "Tanshikar's Working Spice Farm",
        subtitle: "Netravali Village",
        description: "Variety of spices besides coffee and cacao",
        image:
          "https://www.planetware.com/wpimages/2020/06/india-goa-top-attractions-tanshikars-working-spice-farm.jpg",
      },
      {
        title: "Hospedaria Venite",
        subtitle: "Panaji",
        description: "Portuguese-Indian Restaurants",
        image:
          "https://www.planetware.com/wpimages/2020/06/india-goa-top-attractions-portuguese-indian-restaurants.jpg",
      },
      {
        title: "Basilica de Bom Jesus",
        subtitle: "Bainguinim",
        description: "The remains of the St. Francis Xavier",
        image:
          "https://www.planetware.com/wpimages/2020/06/india-goa-top-attractions-basilica-bom-jesus.jpg",
      },
      {
        ...
        image:
          "https://www.planetware.com/wpimages/2020/06/india-goa-top-attractions-dudhsagar-falls.jpg",
      },
    ],
  },
  {
    ...
    stateName: "Punjab",
    content:
      "It is known as 'the land of five rivers' and because of the fertile lands found here, it is also amongst one of the most ancient civilizations in the world.This place is rich with culture and full of beauty that you should experience first - hand.",
    url: s5,
    slides: [
      {
        title: "The Golden Temple",
        subtitle: "Amritsar",
        description: "Known for legends, patriotism, and spirituality",
        image:
          "https://cdn.pixabay.com/photo/2018/01/15/10/41/amritsar-3083693_960_720.jpg",
      },
      {
        title: "Jallianwala Bagh",
        subtitle: "Amritsar",
        description: "Etched in the mind of Indians forever",
        image:
          "https://static2.tripoto.com/media/filter/nl/img/77414/TripDocument/1524808373_02.jpg",
      },
      {
        title: "Butterfly Park In Punjab",
        subtitle: "Chandigarh",
        description: "The first butterfly park in India",
        image:
          "http://www.flowerspicture.org/srirangam-butterfly-park/enlarge/ideopsis-vulgaris-macrina-statue.jpg",
      },
      {
        title: "Lodhi Fort",
        subtitle: "Ludhiana",
        description: "A storehouse of Punjabi history",
        image:
          "https://res.cloudinary.com/thrillophilia/image/upload/c_fill,f_auto,fl_progressive.strip_profile,g_auto,h_600,q_auto,w_auto/v1/filestore/c06pcmtighs2n53otnrksoqk4em7_419153305-eafd5e5cb2-k.jpg",
      },
      {
        title: "Rock Garden",
        subtitle: "Chandigarh",
        ...
        image:
          "https://akm-img-a-in.tosshub.com/indiatoday/images/story/202201/rock_garden_%281%29.jpg?size=1200:675",
      },
    ],
  },
  {
    ...
    content:
      "Himachal Pradesh is one of India 's most beautiful states, people often forget the extent or magnitude of its breathtaking beauty. Home to magnificent monasteries which are often surrounded by snow - clad peaks",
    url: s6,
    slides: [
      {
  ...
  },
  {
    ...
    content:
      "Uttar Pradesh is one of the states that aesthetically defines India and its rich history that’s as ancient as the time known.This is the land wherein great sages have emerged, religions evolved and two great epic of India: Ramayana and Mahabharata have been inspired from.",
    url: s7,
    slides: [
      {
        title: "Taj Mahal",
  ...
  },
  {
    ...
    content:
      " The valleys of Kashmir are untamed and unspoilt.Surrounded by the sublime mountains, these valleys echo nature, beauty and a certain level of mysticism.Charming lakes: The lakes in Kashmir are crystal clear, stunning and pristine, and Srinagar boasts of the Dal and Nageen Lakes.",
    url: s9,
    slides: [
      {
        title: "Nilnag Lake",
  ...
  },
  {
    ...
    stateName: "Karnataka",
    content:
      "Karnataka is home to various forests, beaches, waterfalls, coffee plantations, lakes and all the bounties of nature.The state also boasts of historically significant monuments and structures that attract visitors from far and beyond.",
    url: s10,
    slides: [
      {
        title: "Mysore Palace",
  ...
  },
  {
    ...
    content:
      "Tamil Nadu is a land of varied beauty.It is mostly famous for numerous Hindu temples based on the Dravidian architecture.The temples are of a distinct style, which is famous for its towering Gopuram.Popular temple towns include Madurai, Kanchipuram, Palani, Tiruvallur and Mahabalipuram.",
    url: s11,
    slides: [
      {
        title: "Marina Beach",
  ...
  },
  {
    ...
    content:
      "A large percentage of Maharashtra 's forests and wildlife lie along the Western Ghats or Western Maharashtra and eastern Vidarbha.The Sahyadris hold several beautiful hill stations in their lap, which are cool, beautiful and refreshingly serene.Best of all, they are usually near a city.",
    url: s12,
    slides: [
      {
  ...
  },
  {
    ...
    stateName: "Bihar",
    content:
      "Bihar is an ancient state, its wonders are of a different kind.For the curious traveller, Bihar can be an eye - opener.This is the land of Gautama Buddha, this is where the ancient centre of learning, Nalanda, exists.",
    url: s14,
    slides: [
      {
        title: "Bodhgaya",
  ...
  },
  {
    ...
    stateName: "Sikkim",
    content:
      " Located in the foothills of the Himalayas, the beauty of Sikkim is absolutely breathtaking.Snowcapped mountains, picturesque vistas, lakes, waterfalls and colorful valleys together form the beauty that is Sikkim.",
    url: s15,
    slides: [
      {
        title: "Tsomgo Lake",
